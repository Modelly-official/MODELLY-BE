...
public interface RecruitmentRepositoryCustom {
    ...
    List<RecruitmentListResponseDto> findRecruitmentsByDistance(Long userId, SearchCondition searchCondition, Long cursorId, Double cursorDistance, int size, UserCoordinate userCoordinate);
}
