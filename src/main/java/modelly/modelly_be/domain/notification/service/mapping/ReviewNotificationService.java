...
public class ReviewNotificationService {
    ...
    //디자이너한테 리뷰 알림 전송
    @Transactional
    public NotificationData createReviewNotification(User designer, String modelNickname, Long reviewId) {
    ...
    //모델한테 리뷰 답글 알림 전송
    @Transactional
    public NotificationData createReplyNotification(User model, String designerNickname, Long reviewId) {
